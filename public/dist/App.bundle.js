...
function autocomplete(input, latInput, lngInput) {
  if (!input) return; // skip this fn from running if there isn't any input on the page
...
// this.heart is accessible because it fits in the name parameter in a button inside of a form _storeCard.pug
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 26.9;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -80.1;
...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
            ...
            // dompurify sanitizes the code prevent from a hack from occurring
            // best used for when you are embedding html using JS
        }).catch(function (err) {
            console.log(err);
        });
    });
    ...
    searchInput.on('keyup', function (e) {
        ...
        // Conditional statement for handling key buttons for search bar
